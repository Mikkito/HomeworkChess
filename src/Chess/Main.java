...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("""
               ...
               'castlingShort' или 'castlingLong' - для соответствующей рокировки
               'move 1 1 2 3' - для передвижения фигуры с позиции 1 1 на 2 3(поле это двумерный массив от 0 до 7)
               В текущей версии не реализован механизм мата, если ходов не осталось программу нужно закрыть""");
        System.out.println();
        board.printBoard();
        while (true) {
                ...
                if (s.equals("castlingShort")) {
                    ...
                    try {
                        ...
                        if (board.moveToPosition(line, column, toLine, toColumn)) {
                            ...
                            board.printBoard();
                            System.out.println(board.checkInfo());
